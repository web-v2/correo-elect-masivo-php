...
function sent_mail($addres,$cc,$suj,$data, $path){
    ...
    try {
        ...
        $mail->Username   = 'aplicacionactivosfijos4@gmail.com';        // SMTP username
        $mail->Password   = 'vighrsthiqaahbyq';                   // SMTP password
        ...
        //Recipients
        $mail->setFrom('aplicacionactivosfijos4@gmail.com', 'IRIS SAS');
